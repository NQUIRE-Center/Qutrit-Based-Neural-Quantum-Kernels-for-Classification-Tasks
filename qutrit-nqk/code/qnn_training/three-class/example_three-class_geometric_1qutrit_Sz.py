...
''' =========================================
    ...
    =========================================
'''
from models.qnn_1qutrit_geometric_Sz import QNN_0_Geometric_Sz


MODEL = {
        "name": "QNN_1qutrit_Geometric_Sz",
        "model_class": QNN_0_Geometric_Sz,
    }

EXPERIMENT = {
    "loss_fn": cost_Sz_3class,
    "predict_fn": predict_Sz_3class
}
