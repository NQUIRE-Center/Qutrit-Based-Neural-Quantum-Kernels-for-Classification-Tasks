...
''' =========================================
    ...
    =========================================
'''
from models.qnn_1qutrit_geometric_Fidelity import QNN_0_Geometric_Fidelity


MODEL = {
        "name": "QNN_1qutrit_Geometric_Fidelity",
        "model_class": QNN_0_Geometric_Fidelity,
    }

EXPERIMENT = {
    "loss_fn": cost_fidelity,
    "predict_fn": predict_fidelity
}
...
DATASET_DIR = BASE_DIR / "datasets/three-class/FashionMNIST_5-7-9_3000_5folds"
